...
impl TestObj {
    fn new(val: usize) -> TestObj {
        TestObj(val)
    }
}

impl Deserializer for TestObj {}

impl Serializer for TestObj {}
...
fn create_and_read_cache() {
    ...
    c.create(&String::from("1"), TestObj::new(10));
    c.create(&String::from("2"), TestObj::new(12));
...
fn create_existing_value() {
    ...
    c.create(&String::from("1"), TestObj::new(10));
    let value = c.create(&String::from("1"), TestObj::new(11));
...
fn update_and_read_cache() {
    let mut c = MaxSizeHashMapCache::new(5);
    c.create(&String::from("1"), TestObj::new(10));
    c.update(&String::from("1"), TestObj::new(9));
...
fn update_a_non_existing_value() {
    let mut c = MaxSizeHashMapCache::new(5);
    let value = c.update(&String::from("1"), TestObj::new(9));
...
fn delete_and_read_cache() {
    let mut c = MaxSizeHashMapCache::new(5);
    c.create(&String::from("1"), TestObj::new(1));
    c.create(&String::from("2"), TestObj::new(2));
...
fn cache_size_exceeds() {
    let mut c = MaxSizeHashMapCache::new(2);
    c.create(&String::from("1"), TestObj::new(10));
    c.create(&String::from("2"), TestObj::new(10));

    let value = c.create(&String::from("6"), TestObj::new(10));
